	...
	<div class="cls-content">
		<div class="cls-content-sm panel">
			<div class="panel-body">
				...
				<form id="frm-signin" action="{{ route('password.request') }}" method="POST">
				 @csrf
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" name='email' class="form-control" value="{{ $email ?? old('email') }}" placeholder="E-mail" required>
						</div>
					</div>
