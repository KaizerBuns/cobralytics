	...
	<div class="col-xs-12">
		<div class="tab-base">
			<ul id="cb-tab-menu" class="nav nav-tabs">
				...
				<li>
					<a href="/member/report/?view=overview&tab=lp&limit=100&page=1&filter[lp]={{ $offer->id }}"><i class="fa fa-bar-chart-o"></i> View in Reports</a>
				</li>
			</ul>
